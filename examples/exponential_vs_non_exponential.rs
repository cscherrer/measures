...
fn main() {
    ...
    println!("  Normal: {:.6}", normal_log_density);
    println!("  Cauchy: {:.6}", cauchy_log_density);
    ...
    println!("  log(Normal/Cauchy): {:.6}", normal_wrt_cauchy);
    println!("  log(Cauchy/Normal): {:.6}", cauchy_wrt_normal);
    println!("  Sum (should be ~0): {:.10}", normal_wrt_cauchy + cauchy_wrt_normal);
