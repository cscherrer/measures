...
fn main() {
    ...
    // IID analysis
    let iid_log_density: f64 = iid_normal.iid_log_density(&test_sample);
    println!("\nIID analysis:");
    ...
    let poisson_iid_log_density = iid_poisson.iid_log_density(&poisson_sample);
    println!("\nIID analysis:");
    ...
    let base_log_likelihood = iid_normal.iid_log_density(&base_sample);
    ...
    for multiplier in 2..=4 {
        ...
        let repeated_log_likelihood = iid_normal.iid_log_density(&repeated_sample);
    ...
    for (name, model) in &models {
        ...
        let log_likelihood = iid_model.iid_log_density(&comparison_data);
