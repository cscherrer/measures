...
pub trait ExponentialFamilyExpr: MathExpr {
    ...
    where 
        Self::Repr<T>: Clone
    {
        assert_eq!(natural_params.len(), sufficient_stats.len(), 
        ...
        Self::Repr<T>: Clone
    {
        ...
        Self::add(
            Self::sub(dot_product, log_partition),
            log_base_measure
        )
    }
...
pub mod patterns {
    ...
    pub fn standard_normal_log_density<E: ExponentialFamilyExpr>(
        x: E::Repr<f64>
    ) -> E::Repr<f64> 
    where 
        E::Repr<f64>: Clone
        ...
        E::Repr<f64>: Clone
    {
        ...
        E::sub(
            E::sub(
                E::mul(x.clone(), E::ln(lambda.clone())),
                lambda
            ),
